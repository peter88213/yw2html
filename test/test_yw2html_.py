...
def remove_all_testfiles():
    try:
        os.remove(TEST_EXEC_PATH + YW7_NORMAL)
    except:
        pass
    try:
...
class NormalOperation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        copyfile(TEST_DATA_PATH + YW7_NORMAL, TEST_EXEC_PATH + YW7_NORMAL)

    def test_scenelist(self):
        os.chdir(TEST_EXEC_PATH)
        yw2html_.run(TEST_EXEC_PATH + YW7_NORMAL, TEMPLATE_PATH +
    ...
    def test_templates_included(self):
        os.chdir(TEST_EXEC_PATH)
        copyfile(TEST_DATA_PATH + YW7_INCL, TEST_EXEC_PATH + YW7_NORMAL)
        yw2html_.run(TEST_EXEC_PATH + YW7_NORMAL, '', '_paperback', True)
